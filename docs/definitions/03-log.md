...
Print error and return err to parent.
...
### Equal(cond1, cond2, fmt)

Debugger friendly assert that also prints lhs and rhs, given format string.
...
### NotEqual(cond1, cond2, fmt)

Not equal version of above.
